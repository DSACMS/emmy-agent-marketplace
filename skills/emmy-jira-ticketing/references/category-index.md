...
| ------------------------------- | ------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------- |
| `engineering-implementation.md` | Code, application behavior, CI, observability, data model, automation, or implementation work          | `engineering`, implementation, repo, tests, production behavior                   |
| `devops-platform.md`            | Deployment, infrastructure, environments, CMS Cloud, Terraform, runbooks, operational readiness        | `devops`, deploy, migration, UAT, Terraform, Observability, Deployment Management |
...
| `product-process-story.md`      | Product, state-facing, pilot-ready, policy/process, roadmap, or state TA collaboration work            | Team `Emmy Product`, state collaboration, pilot-ready, process story              |
...
- Engineering plus ATO: read `engineering-implementation.md` and
  `ato-traceability.md`.
- DevOps plus ATO: read `devops-platform.md` and `ato-traceability.md`.
...
- Engineering implementation: `FFS-4485`, `FFS-4501`, `FFS-4486`
- DevOps/platform/ATO infrastructure: `FFS-4483`, `FFS-4484`, `FFS-4140`
